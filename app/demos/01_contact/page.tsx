  ...
  return (
    <main>
      <div>
        ...
        <ul>
          <li>
            The user is not able to submit the form without completing all
          ...
          <li>
            ...
            data as a response to the client.
          </li>
          <li>
      ...
      {submissionResponse ? (
        ...
        <form className={formClassName} onSubmit={handleSubmit}>
          ...
          <input
            ...
            id="email"
            name="email"
            placeholder="Enter a valid email address for the recipient"
